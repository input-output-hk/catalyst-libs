...
static SYNC_READY: LazyLock<SkipMap<Network, RwLock<SyncReady>>> = LazyLock::new(|| SkipMap::new());
...
pub(crate) fn wait_for_sync_ready(chain: Network) -> SyncReadyWaiter {
    ...
    tokio::spawn(async move {
        ...
        let lock_entry = SYNC_READY.get_or_insert_with(chain, || RwLock::new(SyncReady::new()));
