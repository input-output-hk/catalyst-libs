...
//! <https://docs.dev.projectcatalyst.io/libs/main/architecture/08_concepts/signed_doc/docs/category_parameters_form_template>
...
// campaign_parameters_form_template_doc(&parameters, provider).inspect(|v|
// provider.add_document(v).unwrap())?;         let parameters =
// campaign_parameters_doc(&parameters, &template, provider).inspect(|v|
