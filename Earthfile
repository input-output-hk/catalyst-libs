...
IMPORT github.com/input-output-hk/catalyst-ci/earthly/mdlint:fix/ci AS mdlint-ci
IMPORT github.com/input-output-hk/catalyst-ci/earthly/cspell:fix/ci AS cspell-ci
IMPORT github.com/input-output-hk/catalyst-ci/earthly/python:fix/ci AS python-ci
IMPORT github.com/input-output-hk/catalyst-ci:fix/ci AS cat-ci
