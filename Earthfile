...
IMPORT github.com/input-output-hk/catalyst-ci/earthly/python:fix/wasm-c-base AS python-ci
IMPORT github.com/input-output-hk/catalyst-ci:fix/wasm-c-base AS cat-ci
